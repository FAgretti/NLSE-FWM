...
#plt.savefig(f"nlseGPUh{sys.argv[1]}salida.png")
...
plt.savefig(f"nlseGPUh{sys.argv[1]}imfreq.png")
plt.figure()
...
#plt.savefig(f"nlseGPUh{sys.argv[1]}imtime.png")
...
#for sys.argv[1] in range(len(ind[0])):
#    suma = suma + np.abs(AW[:,ind[0][sys.argv[1]]])**2
...
#plt.savefig(f"nlseGPUh{sys.argv[1]}.png")
